...
class TestPhotoslurp(unittest.TestCase):
    host = "http://10.0.75.1:5000/"
    def test_postWorking(self):
        url = "http://funcionaElPost.com"
        
        r = requests.post(self.host+"Photoslurp/importByURL",data ={"url":url})
